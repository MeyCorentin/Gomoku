...
std::pair<int, int> MinMax::playTurn()
{
    ...
    if (!is_begin)
    {
        if (evaluation_attack[std::distance(evaluation_attack.begin(), max_eval_attack)].score >= 1)
            return evaluation_attack[std::distance(evaluation_attack.begin(), max_eval_attack)].position;
        if (evaluation_defense[std::distance(evaluation_defense.begin(), max_eval_defense)].score >= 1)
    ...
    if (evaluation_attack[std::distance(evaluation_attack.begin(), max_eval_attack)].score >= 1)
        return evaluation_attack[std::distance(evaluation_attack.begin(), max_eval_attack)].position;
    if (evaluation_defense[std::distance(evaluation_defense.begin(), max_eval_defense)].score >= evaluation_attack[std::distance(evaluation_attack.begin(), max_eval_attack)].score)
        return evaluation_defense[std::distance(evaluation_defense.begin(), max_eval_defense)].position;
    else
        return evaluation_attack[std::distance(evaluation_attack.begin(), max_eval_attack)].position;
